...
export const eoi_eligibility_check_ev_property_suitability = () => {
    ...
    cy.get(elements.error_summary_title).contains(error.err_summary_title_msg).should('be.visible').wait(200)
...
export const residential_address_validation_ev_s4 = () => {
    ...
    cy.get(elements.error_summary_title).contains(error.err_summary_title_msg).should('be.visible').wait(250)
...
export const hosting_details_ev_s5 = () => {
    ...
    cy.get(elements.continue_button).click().wait(250)
    cy.get(elements.difaddress_error_label).should('be.visible').wait(250)
    cy.get(elements.error_summary_title).contains(error.err_summary_title_msg).should('be.visible').wait(250)
    cy.xpath(elements.error_sbox_sel_option_msg).contains(error.radiobtn_error_msg).should('be.visible')
    cy.get(elements.difadd_yes_error_radiobtn).click().wait(250)
    cy.get(elements.continue_button).click().wait(500)
}
...
export const offering_property_address_validation_ev_s6 = () => {
    ...
    cy.get(elements.error_summary_title).contains(error.err_summary_title_msg).should('be.visible').wait(250)
    cy.xpath(elements.offering_addressl1_error_sbox_msg).contains(error.addl1_err_msg).should('be.visible').wait(250)
    ...
    cy.get(elements.error_summary_title).should('not.exist').wait(250)
    cy.xpath(elements.offering_addressl1_error_sbox_msg).should('not.exist')
    cy.xpath(elements.offering_townorcity_error_sbox_msg).should('not.exist')
...
export const more_properties_ev_s7_8 = () => {
    ...
    cy.get(elements.error_summary_title).contains(error.err_summary_title_msg).should('be.visible').wait(250)
    cy.xpath(elements.error_sbox_sel_option_msg).contains(error.radiobtn_error_msg).should('be.visible').wait(250)
    cy.get(elements.more_properties_yes_error_radiobtn).click().wait(250)
    cy.get(elements.continue_button).click().wait(250)
...
export const accommodation_details_ev_s11 = () => {
    ...
    cy.get(elements.error_summary_title).contains(error.err_summary_title_msg).should('be.visible').wait(250)
    cy.xpath(elements.error_sbox_sel_option_msg).contains(error.radiobtn_error_msg).should('be.visible').wait(250)
    cy.get(elements.nopref_radiobtn).click().wait(250)
    cy.get(elements.continue_button).click().wait(250)
}

export const no_of_bedrooms_ev_s12 = () => {
    cy.get(elements.page_heading).contains('How many bedrooms are available for guests in the property you’re registering now?').should('be.visible').wait(250)
    cy.get(elements.hinttext).contains(bodytext.bedrooms_hint).should('be.visible').wait(250)
    cy.get(elements.continue_button).click().wait(250)
    ...
    cy.get(elements.dbbedroom_error).should('not.exist')
    cy.get(elements.sbedroom_error_sbox_msg).should('not.exist')
    cy.get(elements.dbbedroom_error_sbox_msg).should('not.exist').wait(250)
}
...
export const take_part_in_research_ev_s15 = () => {
    ...
    cy.get(elements.continue_button).click().wait(250)
    cy.get(elements.research_error_label).contains(error.radiobtn_error_msg).should('be.visible').wait(250)
    cy.get(elements.error_summary_title).contains(error.err_summary_title_msg).should('be.visible').wait(250)
...
export const consent_ev_s16 = () => {
    ...
    cy.get(elements.continue_button).click().wait(250)
    cy.get(elements.consent_error_label).contains(error.consent_err_msg).should('be.visible').wait(250)
    cy.get(elements.error_summary_title).contains(error.err_summary_title_msg).should('be.visible')
    cy.get(elements.consent_error_sbox_msg).contains(error.consent_err_msg).should('be.visible')
    cy.get(elements.consent_checkbox_error).click().wait(250)
    cy.get(elements.continue_button).click().wait(500)
}
