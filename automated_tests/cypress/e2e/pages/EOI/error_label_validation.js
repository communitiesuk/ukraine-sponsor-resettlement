...
export const no_of_bedrooms_ev_s12 = () => {
    ...
    cy.get(elements.continue_button).click().wait(250)
    cy.get(elements.error_summary_error_list_first).contains(error.number_of_brooms_err_msg).should('be.visible').wait(250)
    cy.get(elements.sbedroom_error).should('not.exist')
    cy.get(elements.dbbedroom_error).should('not.exist').wait(250)
...
export const stepfree_access_details_ev_s13 = () => {
    cy.visit('/expression-of-interest/steps/13').wait(250)
