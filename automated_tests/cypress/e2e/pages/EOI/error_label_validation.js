...
export const residential_address_validation_ev_s4 = () => {
    ...
    cy.get(elements.error_summery_title).contains(error.err_summery_title_msg).should('be.visible').wait(250)
...
export const no_of_bedrooms_ev_s12 = () => {
    ...
    cy.get(elements.continue_button).click().wait(250)
    cy.get(elements.error_summery_error_list_first).contains(error.number_of_brooms_err_msg).should('be.visible').wait(250)
