...
export const adults_and_children_v1 = () => {
    cy.get(elements.adults_textbox).clear().type(4)
    cy.get(elements.children_textbox).clear()
    cy.get(elements.continue_button).click().wait(Cypress.env('waitTime'))
...
export const adults_and_children_v2 = () => {
    ...
    cy.get(elements.children_textbox).clear().type(2)
    cy.get(elements.continue_button).click().wait(Cypress.env('waitTime'))
    cy.get(elements.adults_error).should('exist')
...
export const adults_and_children_v3 = () => {
    cy.get(elements.adults_textbox).clear().type(10)
...
export const adults_and_children_v4 = () => {
    cy.get(elements.adults_textbox).clear().type(9)
...
export const adults_and_children_v5 = () => {
    ...
    cy.get(elements.children_textbox).clear().type(20)
    cy.get(elements.continue_button).click().wait(Cypress.env('waitTime'))
...
export const adults_and_children_v6 = () => {
    cy.get(elements.adults_textbox).clear().type(100)
    cy.get(elements.children_textbox).clear().type(0)
    cy.get(elements.continue_button).click().wait(Cypress.env('waitTime'))
    cy.get(elements.adults_error).should('exist')
    cy.get(elements.children_error).should('not.exist')
}
...
export const adults_and_children_v7 = () => {
    cy.get(elements.adults_textbox).clear().type(1000)
