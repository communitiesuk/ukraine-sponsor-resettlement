...
export const eoi_eligibility_check = () => {
    ...
    cy.get(elements.yes_radiobtn).click().wait(250)
    cy.get(elements.sa_continue_button).click().wait(250)
    ...
    cy.get(elements.england_radiobtn).click().wait(250)
    cy.get(elements.sa_continue_button).click().wait(250)
...
export const your_details_page = () => {
    cy.get(elements.fullname_label).contains('Enter your full name').should('be.visible').wait(250)
    cy.get(elements.fullname_textbox).clear().type(secrets.user_name).wait(250)
    cy.get(elements.continue_button).click().wait(250)
    cy.get(elements.email_label).contains('Enter your email address').should('be.visible').wait(250)
    cy.get(elements.email_textbox).clear().type(secrets.email).wait(250)
    cy.get(elements.continue_button).click().wait(250)
    cy.get(elements.phonenumber_label).contains('Enter your contact telephone number').should('be.visible').wait(250)
    cy.get(elements.phonenumber_textbox).clear().type(secrets.phoneno).wait(250)
...
export const your_property_address = () => {
    ...
    cy.get(elements.postcode_textbox).clear().type('NW10 3WE').wait(250)
    cy.get(elements.continue_button).click().wait(250)
    cy.get(elements.page_heading).contains('Is the property you’re offering at a different address to your home?').should('be.visible').wait(250)
    cy.get(elements.difadd_yes_radiobtn).click().wait(250)
    cy.get(elements.continue_button).click().wait(250)
    cy.get(elements.page_heading).contains("Enter the address of the property you're offering").should('be.visible').wait(250)
    cy.get(elements.offering_addressl1_textbox).clear().type('Property One Address').wait(250)
    ...
    cy.get(elements.offering_postcode_textbox).clear().type('KT20 3KE').wait(250)
    cy.get(elements.continue_button).click().wait(500)
}
...
export const more_properties = () => {
    ...
    cy.get(elements.more_properties_yes_radiobtn).click().wait(250)
    cy.get(elements.continue_button).click().wait(250)
    cy.get(elements.anymore_properties_label).contains(bodytext.more_properties_to_offer).should('be.visible').wait(250)
    cy.get(elements.continue_button).click().wait(500)
}

export const hosting_details = () => {
    cy.get(elements.start_hosting_heading).contains('How soon can you start hosting someone?').should('be.visible').wait(250)
...
export const accommodation_details = () => {
    cy.get(elements.page_heading).contains('Who would you like to offer accommodation to? ').should('be.visible').wait(250)
    cy.get(elements.morethanone_radiobtn).click().wait(250)
    cy.get(elements.continue_button).click().wait(250)
    ...
    cy.get(elements.sbedroom_textbox).clear().type('4').wait(250)
    cy.get(elements.dbbedroom_textbox).clear().type('2').wait(250)
    cy.get(elements.continue_button).click().wait(500)
}
...
export const stepfree_access_details = () => {
    ...
    cy.get(elements.stepfree_yta_radiobtn).click().wait(250)
    cy.get(elements.continue_button).click().wait(250)
}

export const pets_details = () => {
    cy.get(elements.pets_heading).contains('Would you consider allowing guests to bring their pets?').should('be.visible').wait(250)
    cy.get(elements.pets_yes_radiobtn).click().wait(250)
    cy.get(elements.continue_button).click().wait(250)
}

export const take_part_in_research = () => {
    cy.get(elements.research_heading).contains('Would you like to take part in research to help us improve the Homes for Ukraine service?').should('be.visible').wait(250)
    cy.get(elements.research_yes_radiobtn).click().wait(250)
    cy.get(elements.continue_button).click().wait(250)
}

export const consent = () => {
    cy.get(elements.consent_heading).contains('Confirm you have read the privacy statement and agree that the information you have provided in this form can be used for the Homes for Ukraine scheme').should('be.visible').wait(250)
    cy.get(elements.consent_checkbox).click().wait(250)
    cy.get(elements.continue_button).click().wait(250)
}

export const check_your_answers = () => {
    cy.get(elements.page_heading).contains('Check your answers before sending your registration').should('be.visible').wait(250)
    cy.get(elements.cya_name).contains(secrets.user_name).should('be.visible').wait(250)
    cy.get(elements.cya_email).contains(secrets.email).should('be.visible')
    cy.get(elements.cya_phone).contains(secrets.phoneno).should('be.visible').wait(250)
...
export const accept_send = () => {
    cy.get(elements.continue_button).click().wait(250)
    cy.get(elements.registration_complete_heading).contains('Thank you for registering').should('be.visible').wait(250)
    cy.get(elements.ref_number).contains('EOI').should('be.visible').wait(500)
}
