var page_elements = {
    ...
    main_heading: ".govuk-heading-l",
    page_heading: ".govuk-heading-l",
    page_heading_xl: ".govuk-heading-xl",
    ...
    spon_fam_link: "//a[normalize-space()='Sponsor a family member from Ukraine (opens in a new tab)']",
    spon_alknow_link: "//a[normalize-space()='Sponsor someone you already know from Ukraine (opens in a new tab)']",
    register_link: "//a[normalize-space()='Register your interest with Homes for Ukraine (opens in a new tab)']",
    //step1
    ...
    biometric_residence_label: 'label[for="unaccompanied-minor-identification-type-biometric-residence-field"]',
    photo_driving_licence_label: 'label[for="unaccompanied-minor-identification-type-photo-driving-licence-field"]',
    ...
    step16_idha_radio_btn: "#unaccompanied-minor-identification-type-none-field",
    step16_pp_label: "label[for='unaccompanied-minor-passport-identification-number-field-error']",
    step16_ni_label: "label[for='unaccompanied-minor-id-identification-number-field-error']",
    step16_biom_label: "label[for='unaccompanied-minor-biometric-residence-identification-number-field-error']",
    step16_pdl_label: "label[for='unaccompanied-minor-photo-driving-licence-identification-number-field-error']",
    step16_pp_err_msg: "#unaccompanied-minor-passport-identification-number-error",
    step16_ni_err_msg: "#unaccompanied-minor-id-identification-number-error",
    step16_biom_err_msg: "#unaccompanied-minor-biometric-residence-identification-number-error",
    step16_pdl_err_msg: "#unaccompanied-minor-photo-driving-licence-identification-number-error",
    step16_noid_err_msg: "#unaccompanied-minor-no-identification-reason-error",
    ...
    residents_biom_number_label: "label[for='unaccompanied-minor-adult-biometric-residence-identification-number-field']",
    residents_biom_number_textbox: '#unaccompanied-minor-adult-biometric-residence-identification-number-field',
    residents_pdl_number_label: "label[for='unaccompanied-minor-adult-photo-driving-licence-identification-number-field']",
    residents_pdl_number_textbox: '#unaccompanied-minor-adult-photo-driving-licence-identification-number-field',
    ...
    step31_biom_err_radio_btn: "#unaccompanied-minor-adult-identification-type-biometric-residence-field",
    step31_biom_err_textbox: "#unaccompanied-minor-adult-biometric-residence-identification-number-field-error",
    step31_biom_err_msg: "#unaccompanied-minor-adult-biometric-residence-identification-number-error",
    step31_biom_label:"label[for='unaccompanied-minor-adult-biometric-residence-identification-number-field-error']",
    step31_pdl_err_radio_btn: "#unaccompanied-minor-adult-identification-type-photo-driving-licence-field",
    step31_pdl_err_textbox: "#unaccompanied-minor-adult-photo-driving-licence-identification-number-field-error",
    step31_pdl_err_msg: "#unaccompanied-minor-adult-photo-driving-licence-identification-number-error",
    step31_pdl_label:"label[for='unaccompanied-minor-adult-photo-driving-licence-identification-number-field-error']",
    ...
    step35_pcf_link: "//a[normalize-space()='Read guidance about parental consent forms (opens in a new tab)']",
    //step36
    ...
    step39_gui_link: "//a[normalize-space()='guidance for sponsoring a child fleeing Ukraine (opens in a new tab)']",
    //send application
    ...
    comp_ano_app: "//a[normalize-space()='complete another application (opens in a new tab)']",
    //links
    fn_cng_link: "(//a[@class='govuk-link'])[4]",
    email_cng_link: "(//a[@class='govuk-link'])[5]",
    mob_cng_link: "(//a[@class='govuk-link'])[6]",
    id_cng_link: "(//a[@class='govuk-link'])[7]",
    dob_cng_link: "(//a[@class='govuk-link'])[8]",
    nat_cng_link: "(//a[@class='govuk-link'])[9]",
    oth_nat_cng_link: "(//a[@class='govuk-link'])[10]",
    child_live_cng_link: "(//a[@class='govuk-link'])[11]",
    child_fn_cng_link: "(//a[@class='govuk-link'])[12]",
    child_email_cng_link: "(//a[@class='govuk-link'])[13]",
    child_dob_cng_link: "(//a[@class='govuk-link'])[14]",
    uk_const_cng_link: "(//a[@class='govuk-link'])[15]",
    ukr_const_cng_link: "(//a[@class='govuk-link'])[16]",
    const_data_share_cng_link: "(//a[@class='govuk-link'])[17]",
    commit_cond_cng_link: "(//a[@class='govuk-link'])[18]",
};
