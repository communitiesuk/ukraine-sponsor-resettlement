...
RSpec.describe "Individual expression of interest", type: :system do
  ...
  describe "submitting the form" do
    ...
    it "saves all of the answers in the database - having gone back from check answers" do
      visit root_path
      expect(page).to have_content("Homes for Ukraine")
      click_link("Register your interest as an individual")
      ...
      # Go back to the different address question and change answer from no to yes
