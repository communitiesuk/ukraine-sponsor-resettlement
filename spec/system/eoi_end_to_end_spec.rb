RSpec.describe "Expression of in interest end to end", type: :system do
    before do
        Capybara.current_driver = :selenium
    end
  
    describe "user successfully completes the eoi journey", js:true do
      fit "entering minimum valid details" do
        puts "ENV[] == #{ENV["FEATURE_EOI_JOURNEY_ENABLED"]}"
        eoi_enter_valid_complete_self_assessment_section
