...
require_relative "support/unaccompanied_minor_helpers"
require_relative "support/eoi_helpers"
...
RSpec.configure do |config|
  ...
  config.include UnaccompaniedMinorHelpers
  config.include EoiHelpers
end
