module UamValidations
  ...
  def validate_uk_parental_consent_tempfile_path
    if @uk_parental_consent_tempfile_path.present?
      if !file_not_malicious?(@uk_parental_consent_tempfile_path)
  ...
  def validate_ukraine_parental_consent_tempfile_path
    if @ukraine_parental_consent_tempfile_path.present?
      if !file_not_malicious?(@ukraine_parental_consent_tempfile_path)
